...
export const products: Product[] = [
  ...
  {
    name: 'LifeSaver Expedition Jerrycan Water Purifier',
    shortName: 'LifeSaver Jerrycan',
    ...
    category: 'survival-filters',
    categoryName: 'Survival & Portable Filters',
    notes: 'Military-grade jerrycan purifier, 18.5L capacity, 0.015 micron ultrafiltration, removes viruses/bacteria/protozoa, 20,000L filter life, failsafe shutoff, NATO jerrycan mount compatible',
    rating: '4.7',
    reviewCount: '1572',
    bestFor: 'Best Vehicle-Mounted Purifier',
    pros: [
      ...
      '18.5L storage doubles as a pressurized water container with spigot',
      'Fits standard NATO jerrycan mounts for vehicle integration',
    ],
    cons: [
      'Heavy at 8.6 lbs empty — strictly vehicle-based, not for backpacking',
      'Expensive at ~$290 upfront plus ~$90 replacement cartridges',
      'Difficult to fill from shallow water sources — requires secondary container to scoop and pour',
      'Spigot/tap assembly is the weakest point and can break if knocked',
    ],
    verdict: 'The LifeSaver Expedition Jerrycan is the gold standard for vehicle-mounted water purification. Its military-grade 0.015-micron membrane removes viruses, bacteria, and protozoa, while the 20,000-liter capacity and FailSafe shutoff make it ideal for overlanding, off-grid living, and emergency preparedness.',
    specs: {
      filtrationStages: '2',
      filtrationTechnology: '0.015μm Ultrafiltration Hollow Fiber Membrane + Activated Carbon',
      micronRating: '0.015',
      capacity: '18.5 liters per fill / 20,000 liters filter life',
      flowRate: '4 L/min at 0.6 bar',
      dimensions: '13.75 x 6.7 x 18.75 inches',
      weight: '8.6 lbs (3.9 kg)',
      filterLife: '20,000 liters (UF cartridge), 500 liters (carbon disc)',
      contaminantsRemoved: 'Viruses (99.99%), bacteria (99.9999%), protozoa (99.99%), chlorine, lead, nickel, cadmium, taste/odor',
    },
    publishDate: PUBLISH_WAVES.wave4,
  ...
  {
    name: 'LifeStraw Peak Series Collapsible Squeeze Bottle 1L',
    shortName: 'LifeStraw Peak Squeeze',
    ...
    category: 'survival-filters',
    categoryName: 'Survival & Portable Filters',
    notes: 'Ultralight collapsible squeeze filter, 0.2 micron hollow-core membrane, 1L capacity, 2,000L filter life, 42mm thread (BeFree compatible), Outdoor Gear Lab Editor\'s Choice',
    rating: '4.3',
    reviewCount: '3500',
    bestFor: 'Best Ultralight Squeeze Filter',
    pros: [
    ...
    verdict: 'The LifeStraw Peak Squeeze is an Outdoor Gear Lab Editor\'s Choice for good reason. At 3.8 oz with fast flow rates and a durable collapsible design, it is the best ultralight squeeze filter for thru-hikers and trail runners who need speed and minimal weight.',
    specs: {
      filtrationStages: '1',
      filtrationTechnology: '0.2μm Hollow-Core Membrane Microfilter',
      micronRating: '0.2',
      capacity: '1 liter per fill / 2,000 liters filter life',
      flowRate: '~1.7 L/min (real-world)',
      dimensions: '4.7 x 12.1 inches',
      weight: '3.8 oz (108g, complete system)',
      filterLife: '2,000 liters (500 gallons)',
      contaminantsRemoved: 'Bacteria (99.999999%), protozoa (99.999%), microplastics (99.999%)',
    },
    publishDate: PUBLISH_WAVES.wave5,
  ...
  {
    name: 'Sawyer Micro Squeeze Water Filtration System',
    shortName: 'Sawyer Micro Squeeze',
    ...
    category: 'survival-filters',
    categoryName: 'Survival & Portable Filters',
    notes: 'Ultracompact 0.1 micron hollow fiber filter, 1.65 oz, 100,000 gallon capacity, Cnoc Premium 750ml bladder bundle, 28mm thread compatible',
    rating: '4.7',
    reviewCount: '2500',
    bestFor: 'Best Ultracompact Backpacking Filter',
    pros: [
    ...
    verdict: 'The Sawyer Micro Squeeze is the go-to filter for ultralight backpackers who want Sawyer reliability in the smallest possible package. At 1.65 oz with 100,000-gallon capacity, it is the best weight-to-performance ratio in portable water filtration — paired here with a Cnoc Premium bladder that fixes Sawyer\'s notorious pouch quality issues.',
    specs: {
      filtrationStages: '1',
      filtrationTechnology: '0.1μm Absolute Hollow Fiber Membrane',
      micronRating: '0.1',
      capacity: '100,000 gallons (378,000 liters)',
      flowRate: '~1.4 L/min (squeeze)',
      dimensions: '1.59 x 1.59 x 4.22 inches (filter)',
      weight: '1.65 oz dry (47g) / ~4 oz with Cnoc bladder',
      filterLife: '100,000 gallons',
      contaminantsRemoved: 'Bacteria (99.99999%), protozoa (99.9999%), microplastics (100%)',
    },
    publishDate: PUBLISH_WAVES.wave6,
