...
export const products: Product[] = [
  ...
  {
    name: 'GRAYL Tap Water Filter Bottle',
    shortName: 'GRAYL Tap Filter',
    slug: 'grayl-tap-water-filter',
    brand: 'GRAYL',
    asin: 'B0B7MLQJ6Q',
    price: '59.95',
    category: 'survival-filters',
    categoryName: 'Survival & Portable Filters',
    notes: 'Press filter bottle for municipal/tap water, removes chlorine/lead/PFAS/microplastics, 150-gallon cartridge life',
    rating: '4.3',
    reviewCount: '1800',
    bestFor: 'Best for Tap Water Improvement',
    pros: [
      'Designed specifically for improving municipal and tap water quality',
      'Removes chlorine, lead, PFAS, microplastics, and chemicals from treated water',
      '150-gallon cartridge life — 3-4x longer than GRAYL purifier cartridges',
      'Same press design for fast, easy operation',
      'Great for office, gym, and travel where tap water is available but tastes bad',
    ],
    cons: [
      'NOT a purifier — does not remove viruses, bacteria, or protozoa from raw water',
      'Only suitable for pre-treated municipal water, not backcountry sources',
      'Niche product — most users want either a purifier or a simple bottle',
      'At $59.95, expensive compared to a Brita pitcher for the same function',
    ],
    verdict: 'The GRAYL Tap is a well-made solution for people who travel to cities with poor-tasting but treated water. It is NOT for backcountry use. If your concern is chlorine, lead, and chemicals in tap water on the go, this delivers.',
    specs: {
      filtrationStages: '2',
      filtrationTechnology: 'Activated carbon + ion exchange (tap water filter)',
      capacity: '16.9 oz per press, ~150 gallons per cartridge',
      flowRate: '16.9 oz in 8 seconds (press)',
      dimensions: '9.0 x 2.9 inches',
      weight: '10.2 oz',
      filterLife: '~150 gallons',
      contaminantsRemoved: 'Chlorine, lead, PFAS, microplastics, chemicals, pesticides, herbicides',
    },
    publishDate: PUBLISH_WAVES.wave5,
    legacyUrls: ['/products/grayl-tap-water-filter'],
  },
  {
  ...
  {
    name: 'Survivor Filter Pro X Electric Water Purifier Pump',
    shortName: 'Survivor Filter Pro X (Pump)',
    slug: 'survivor-filter-pro-x-electric-pump',
    brand: 'Survivor Filter',
    asin: 'B08Q7KM59X',
    price: '69.95',
    category: 'survival-filters',
    categoryName: 'Survival & Portable Filters',
    notes: 'Electric pump purifier, USB-C rechargeable, 0.01 micron, 3-stage, no hand pumping, 750ml/min',
    rating: '4.3',
    reviewCount: '2800',
    bestFor: 'Best Electric Pump Filter',
    pros: [
      ...
      'Same 0.01 micron 3-stage filtration as the Pro with virus testing',
      'Great for large-volume filtering at camp or in emergencies',
    ],
    cons: [
      'Battery dependency — useless when charge runs out in the field',
      'Heavier at 9.5 oz than manual pump alternatives',
      'Electronic components add failure points in rough conditions',
      'Higher price than manual version without significantly better filtration',
    ],
    verdict: 'The Pro X Electric is the laziest way to get clean water in the field — no pumping, no squeezing, just push a button. The USB-C charging is smart, but battery dependence is a real risk for extended backcountry trips. Best for car camping and emergency prep with power access.',
    specs: {
      filtrationStages: '3',
      filtrationTechnology: 'Cotton Pre-filter + 0.01μm UF Membrane + Activated Carbon',
      micronRating: '0.01',
    ...
    publishDate: PUBLISH_WAVES.wave5,
    legacyUrls: ['/products/survivor-filter-pro-x-electric-pump'],
  },
  {
