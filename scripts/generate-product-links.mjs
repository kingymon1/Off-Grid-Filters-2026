...
lines.push('5. Run the conversion script:');
lines.push('   ```bash');
lines.push('   # Single file');
lines.push('   node scripts/convert-to-webp.mjs public/assets/images/bluevua-ro100ropot-uv-hero.png');
lines.push('');
lines.push('   # All at once');
