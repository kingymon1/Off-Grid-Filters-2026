...
lines.push('## Workflow');
lines.push('');
lines.push('### Option A: Upload via GitHub (Recommended — fully automated)');
lines.push('');
...
lines.push('3. Rename to match the **Image Filename** column (use `.jpeg` or `.png` extension)');
lines.push('4. Go to `public/assets/images/` in GitHub → **Add file → Upload files**');
lines.push('5. Commit to `main` — a GitHub Action auto-converts to WebP, generates responsive');
lines.push('   variants, updates this file, and commits back (~1-2 minutes)');
lines.push('');
lines.push('### Option B: Local workflow (manual)');
lines.push('');
lines.push('1. Download and rename images (steps 1-3 above)');
lines.push('2. Place source files in `public/assets/images/`');
lines.push('3. Run: `node scripts/convert-to-webp.mjs`');
lines.push('4. Run: `npm run product-links`');
lines.push('5. Run: `npm run build`');
lines.push('');
lines.push('See **IMAGE-GUIDE.md → Quick Start** for full details.');
lines.push('');
lines.push('## Notes');
lines.push('');
